...
public class BitmapFilter {
	...
	public static final int ICE_STYLE = 4;		// 冰冻
	public static final int CARTON_STYLE = 5;	// 连环画
	public static final int MOLTEN_STYLE = 6;	// 铸融
	public static final int SOFTNESS_STYLE = 7; // 柔化
	public static final int ECLOSION_STYLE = 8; // 羽化
	public static final int RELIEF_STYLE = 9; 	// 浮雕
	public static final int OIL_STYLE = 10; 	// 油画
	public static final int INVERT_STYLE = 11; 	// 反色
	public static final int LIGHT_STYLE = 12; 	// 光照
	public static final int LOMO_STYLE = 13;	// LOMO
	public static final int HAHA_STYLE = 14;	// 哈哈镜
